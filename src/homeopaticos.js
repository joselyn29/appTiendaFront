  ...
  useEffect(() => {
    ...
    axios.get('http://127.0.0.1:8000/api/productos/')
      .then(response => {
        ...
        const productosAlimentos = response.data.filter(producto => producto.categoria.nombre.toLowerCase() === 'homeopáticos');
      ...
      <div className={styles.containerGrande}>
        ...
        <div className={styles.container}>
          <div className={styles.productosSection}>
            <h2 className={styles.tituloCategoria}>Homeopáticos</h2>
